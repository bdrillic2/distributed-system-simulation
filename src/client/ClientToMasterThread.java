...
public class ClientToMasterThread extends Thread {
	...
	public void run() {
		...
		// for now client will continue generating jobs infinitely in this while loop
		// until we
		// kill the program
		while (stop < 30) {
			// randomly generate id for a job
			id = rand.nextInt(100000000) + 50000000;
			...
			System.out.println(
					"Job ID: " + id + " Type: " + type + " from client " + clientNum + " sent to master server");
