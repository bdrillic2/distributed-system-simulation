...
public class Client {
	public static void main(String[] args) throws IOException {
		...
		try (Socket clientSocket = new Socket(hostName, portNumber); PrintWriter requestWriter = // stream to write text
			...
			/**
			 * Clients are going to connect directly to the master and submit jobs of either
			 * type. The client’s submission should include the type, and an ID number that
